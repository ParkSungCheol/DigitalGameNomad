...
<div className='terms-background'>
    <ul className='join-box'>
        ...
        <li className='checkBox-check2'>
            ...
            <textarea className='terms-box'>제1조(목적)
...
2.1항의 규정에도 불구하고 분쟁으로 인하여 소송이 제기될 경우 소송은 '갑'의 소재지를 관할하는 법원의 관할로 합니다.
        ...
        <li className='checkBox-check3'>
            ...
            한국게임산업협회(DIGITAL GAME NOMAD)는 개인정보보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
            제 1조(개인정보의 처리 목적)
...
- 개인정보보호담당자 : 박성철 부 팀장(skfo8gmlakd@naver.com), 유대현 부 팀장(eogus2604@hanmail.net)
        ...
        <li className='checkBox-check3'>
            ...
            <textarea className='terms-box'>  제 1 조 (목적)
